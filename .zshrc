...
[[ "$TERM_PROGRAM" == "vscode" ]] && ZSH_TMUX_AUTOSTART=false

source $ZSH/oh-my-zsh.sh
# Monokai autosuggestion color
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=#75715E'

# Agnoster Monokai colors (green accent)
AGNOSTER_CONTEXT_FG='#A6E22E'   # green text
AGNOSTER_DIR_BG='#A6E22E'      # green bg
AGNOSTER_DIR_FG='#272822'      # dark text
...
# eza Monokai colors
export EZA_COLORS="di=38;2;166;226;46"
