...
// DefaultDocs is set by the proto code generated by protoc-gen-docs.
// The SDK automatically picks it up in Serve() — plugins do not need
// to set DocsProto explicitly.
var DefaultDocs *dotfilesdv1.Documentation
...
type Config struct {
	...
	// DocsProto is a pre-generated Documentation proto, embedded via
	...
	// If nil, the SDK uses DefaultDocs (auto-registered by protoc-gen-docs).
